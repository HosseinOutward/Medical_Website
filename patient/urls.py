...
from .views import PanelView, PatientCreateView, PatientDetailView, PatientDeleteView, PatientUpdateView, PatientListView, ImageAddView, ImageDeleteView
...
urlpatterns = [
    ...
    path('panel/', PanelView.as_view(), name='base-panel'),
]
